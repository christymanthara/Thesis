...
def tsne_side_by_side_with_metrics(file1, file2, output_pdf=None):
    ...
    X1 = adata1.obsm["X_scVI"]
    X2 = adata2.obsm["X_scVI"]
...
#-------------------------------------------pavlins plotting
    ...
    init = openTSNE.initialization.pca(adata_full.obsm["X_scVI"], random_state=0)
